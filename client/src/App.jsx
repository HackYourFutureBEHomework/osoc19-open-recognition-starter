...
import BgImgae from "../img/bg-img.png";
...
<>
    <Header />
    <div class="" style={{backgroundImage: 'url(' + BgImgae + ')',backgroundRepeat: 'no-repeat', backgroundSize: 'cover',backgroundPosition: 'center' }}>
