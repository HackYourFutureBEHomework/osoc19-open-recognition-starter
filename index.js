...
const userTable = require("./src/database/tables/users-table");
const statementsTable = require("./src/database/tables/statements-table");
const turstRelationTable = require("./src/database/tables/trust-relation-table");
const externalUserTable = require("./src/database/tables/external-user-table");
